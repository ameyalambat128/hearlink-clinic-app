...
const questions = [
  { id: "q1", text: "Dizziness" },
  { id: "q2", text: "Pressure in the ear" },
  { id: "q3", text: "Fullness in the ear" },
  { id: "q4", text: "Plugged feeling in the ear" },
];
...
export default function question13b() {
  ...
  const handleNext = () => {
    addResponse("13b", answers);
    nextQuestion();
  };

  const nextQuestion = () => {
    router.push("/hearingTest/questionnaire/question14");
  };
        ...
        <View className="relative mb-20 mt-6 w-4/5 items-center">
          <View className="w-full rounded-3xl bg-blue-200 p-6 shadow-sm dark:bg-black">
            ...
            <Text className="mb-4 text-left text-lg font-semibold">
              Do you have any of the following symptoms with your tinnitus?
            </Text>
