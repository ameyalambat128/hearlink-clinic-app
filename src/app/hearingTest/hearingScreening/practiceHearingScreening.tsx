...
export default function Screen() {
  ...
  const handleNext = () => {
    router.push("/hearingTest/hearingScreening/hearingScreeningTest");
  };
  ...
  const moveToNextFrequency = () => {
    if (currentFrequencyIndex < frequencies.length - 1) {
      ...
      // router.push("/hearingTest/pureTone/pureToneResults");
    }
  };
      ...
      <View className="flex h-full w-3/4 justify-between">
        ...
        {/* <View className="mt-4 items-center">
          <Text className="text-lg">
            Current Frequency: {frequencies[currentFrequencyIndex]} Hz
          </Text>
          <Text className="text-lg">
            Current Intensity: {currentIntensity} dB
          </Text>
          <TouchableOpacity
            onPress={() => {}}
